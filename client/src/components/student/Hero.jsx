...
const Hero = () => {
  return (
    ...
    <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>We bring together world-class instructors, intercative content , and a supportive community to help you acheive your personal and professional goals.</p>
